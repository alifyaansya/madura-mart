...
<style>
  ...
  .table tbody tr:hover {
    background-color: #f8f1ff; /* ungu lembut */
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="#" class="font-weight-bold" target="_blank">Joker</a>
                for a better web.
              </div>
            </div>
            <div class="col-lg-6">
  ...
  <script>
    ...
    @if (session('duplikat'))
      swal("Duplicate Data!", "{{ session('duplikat') }}", "warning");
    @endif
  </script>
@endsection